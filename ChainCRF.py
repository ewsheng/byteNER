...
Version from Nils Reimers, https://github.com/UKPLab/emnlp2017-bilstm-cnn-crf/blob/master/neuralnets/keraslayers/ChainCRF.py
"""
...
def log_likelihood(y, x, U, b_start=None, b_end=None, mask=None):  # ES: added
